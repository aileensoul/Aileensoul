...
// 1-5 notification end
        ...
        foreach ($artfollow as $art) {
            if ($art['not_from'] == 3) {
                ...
                $notification .= '<li><div class="notification-database">';
                $notification .= '<div class="notification-pic">';
                $notification .= '<img src="' . base_url($this->config->item('user_thumb_upload_path') . $art['user_image']) . '">';
                $notification .= '</div><div class="notification-data-inside">';
        ...
        foreach ($artimglike as $bus) {
            if ($bus['not_from'] == 3) {
                if ($bus['not_img'] == 5) {
                    $notification .= '<li>';
                    $notification .= '<div class="notification-pic">';
                    $notification .= '<img src="' . base_url($this->config->item('user_thumb_upload_path') . $bus['user_image']) . '" >';
                    $notification .= '</div>';
                    $notification .= '<div class="notification-data-inside">';
        ...
        foreach ($work_post as $work) {
            ...
            if ($work['not_from'] == 4) {
                ...
                $notification .= '<li><div class="notification-database">';
                $notification .= '<div class="notification-pic">';
                $notification .= '<img src="' . base_url($this->config->item('user_thumb_upload_path') . $work['user_image']) . '" >';
                $notification .= '</div><div class="notification-data-inside">';
