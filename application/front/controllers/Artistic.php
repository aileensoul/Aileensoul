        ...
        if (!in_array($userid, $likeuserarray)) {
                   ...
                   $designation = $this->db->get_where('art_reg', array('user_id' => $row['user_id']))->row()->designation;
                    ...
                    $return_html .= '</a>
                                ...
                                <div class="dropdown2">
                                    <a onClick="myFunction1(' . $row['art_post_id'] . ')" class="dropbtn2 dropbtn2 fa fa-ellipsis-v">
                                    </a>
...
//            $cmtinsert .= '' . $art['comments'] . '';
//            $cmtinsert .= '</textarea>';
            $cmtinsert .= '<div contenteditable="true" style="display:none; min-height:37px !important; margin-top: 0px!important; margin-left: 1.5% !important; width: 81%;" class="editable_text" name="' . $art['artistic_post_comment_id'] . '"  id="editcommenttwo' . $art['artistic_post_comment_id'] . '" placeholder="Type Message ..." value= ""  onkeyup="commentedittwo(' . $art['artistic_post_comment_id'] .','. $post_id.')" onpaste="OnPaste_StripFormatting(this, event);">' . $art['comments'] . '</div>';
            $cmtinsert .= '<span class="comment-edit-button"><button id="editsubmittwo' . $art['artistic_post_comment_id'] . '" style="display:none" onclick="edit_commenttwo(' . $art['artistic_post_comment_id'] .','. $post_id.')">Save</button></span>';
            $cmtinsert .= '</div></div>';
...
//            $cmtinsert .= '<button id="editsubmittwo' . $art['artistic_post_comment_id'] . '" style="display:none" onClick="edit_commenttwo(' . $art['artistic_post_comment_id'] . ')">Comment</button><div class="art-comment-menu-design"> <div class="comment-details-menu" id="likecomment1' . $art['artistic_post_comment_id'] . '">';
            ...
            if ($art['user_id'] == $userid) {
                ...
                $cmtinsert .= '<div id="editcommentboxtwo' . $art['artistic_post_comment_id'] . '" style="display:block;">';
                $cmtinsert .= '<a id="' . $art['artistic_post_comment_id'] . '"';
                $cmtinsert .= 'onClick="comment_editboxtwo(this.id,'. $post_id.')">';
                $cmtinsert .= 'Edit';
                $cmtinsert .= '</a></div>';
                $cmtinsert .= '<div id="editcancletwo' . $art['artistic_post_comment_id'] . '" style="display:none;">';
                $cmtinsert .= '<a id="' . $art['artistic_post_comment_id'] . '" onClick="comment_editcancletwo(this.id,'. $post_id.')">Cancel  </a></div>';
    ...
    public function insert_commentthreeimg() {
     ...
     //if user deactive profile then redirect to artistic/index untill active profile End
        ...
        foreach ($artcomment as $art_comment) {
            ...
            $cmtinsert .= '</div>';
            $cmtinsert .= '<div contenteditable="true" class="editable_text" name="' . $art_comment['post_image_comment_id'] . '" id="editcommentimg' . $art_comment['post_image_comment_id'] . '"style="display:none;" onkeyup="commenteditimg(' . $art_comment['post_image_comment_id'] .','.$post_image_id.')" onpaste="OnPaste_StripFormatting(this, event);">';

            $cmtinsert .= '' . $art_comment['comment'] . '';
            $cmtinsert .= '</div>';

            $cmtinsert .= '<button id="editsubmitimg' . $art_comment['post_image_comment_id'] . '" style="display:none;" onClick="edit_commentimg(' . $art_comment['post_image_comment_id'] .','.$post_image_id.')">Comment</button><div class="art-comment-menu-design"> <div class="comment-details-menu" id="likecommentimg' . $art_comment['post_image_comment_id'] . '">';
    ...
    public function delete_commentimg() {
     ...
     //if user deactive profile then redirect to artistic/index untill active profile End
        ...
        foreach ($artcomment as $art_comment) {
            ...
            $cmtinsert .= $art_comment['comment'];
            $cmtinsert .= '</div>';
            $cmtinsert .= '<div contenteditable="true"   class="editable_text" name="' . $art_comment['post_image_comment_id'] . '" id="editcommentimg' . $art_comment['post_image_comment_id'] . '"style="display:none;" onkeyup="commenteditimg(' . $art_comment['post_image_comment_id'] .','.$post_delete.')" onpaste="OnPaste_StripFormatting(this, event);">';

            $cmtinsert .= '' . $this->common->make_links($art_comment['comment']) . '';
            $cmtinsert .= '</div>';

            $cmtinsert .= '<button id="editsubmitimg' . $art_comment['post_image_comment_id'] . '" style="display:none;" onClick="edit_commentimg(' . $art_comment['post_image_comment_id'] .','.$post_delete.')">Comment</button><div class="art-comment-menu-design"> <div class="comment-details-menu" id="likecommentimg' . $art_comment['post_image_comment_id'] . '">';
     ...
     //if user deactive profile then redirect to artistic/index untill active profile End
        ...
        if (count($artcomment) > 0) {
            foreach ($artcomment as $art_comment) {
                ...
                $cmtinsert .= $this->common->make_links($art_comment['comment']);
                $cmtinsert .= '</div>';
                $cmtinsert .= '<div contenteditable="true" class="editable_text" name="' . $art_comment['post_image_comment_id'] . '" id="editcommentimgtwo' . $art_comment['post_image_comment_id'] . '"style="display:none;" onkeyup="commenteditimgtwo(' . $art_comment['post_image_comment_id'] .','.$post_delete.')" onpaste="OnPaste_StripFormatting(this, event);">';

                $cmtinsert .= '' . $art_comment['comment'] . '';
                $cmtinsert .= '</div>';

                $cmtinsert .= '<button id="editsubmitimgtwo' . $art_comment['post_image_comment_id'] . '" style="display:none;" onClick="edit_commentimgtwo(' . $art_comment['post_image_comment_id'] .','.$post_delete.')">Comment</button><div class="art-comment-menu-design"> <div class="comment-details-menu" id="likecommentimg' . $art_comment['post_image_comment_id'] . '">';
    ...
    public function fourcommentimg($postid) {
     ...
     //if user deactive profile then redirect to artistic/index untill active profile End
        ...
        foreach ($artmulimage1 as $rowdata) {
            ...
            $fourdata .= '<div contenteditable="true" class="editable_text" name="' . $rowdata['post_image_comment_id'] . '" id="editcommentimgtwo' . $rowdata['post_image_comment_id'] . '" style="display:none; margin-left: 1.5% !important; width: 81%;"  onClick="commenteditimgtwo(' . $rowdata['post_image_comment_id'] .','.$image_id.')" onpaste="OnPaste_StripFormatting(this, event);">';

            $fourdata .= '' . $rowdata['comment'] . '';
            $fourdata .= '</div>';

            $fourdata .= '<button id="editsubmitimgtwo' . $rowdata['post_image_comment_id'] . '" style="display:none; margin-left:15px;" onClick="edit_commentimgtwo(' . $rowdata['post_image_comment_id'] .','.$image_id. ')">Save</button>';
     ...
     //if user deactive profile then redirect to artistic/index untill active profile End
        ...
        foreach ($artcomment as $art_comment) {
           ...
           // $cmtinsert .= '<img  src="' . base_url(NOIMAGE) . '" alt="">  </div>';
            ...
            $cmtinsert .= $this->common->make_links($art_comment['comment']);
            $cmtinsert .= '</div>';
            $cmtinsert .= '<div contenteditable="true" class="editable_text" name="' . $art_comment['post_image_comment_id'] . '" id="editcommentimgtwo' . $art_comment['post_image_comment_id'] . '"style="display:none;" onkeyup="commenteditimgtwo(' . $art_comment['post_image_comment_id'] .','.$post_image_id.')" onpaste="OnPaste_StripFormatting(this, event);">';

            $cmtinsert .= '' . $art_comment['comment'] . '';
            $cmtinsert .= '</div>';

            $cmtinsert .= '<button id="editsubmitimgtwo' . $art_comment['post_image_comment_id'] . '" style="display:none;" onClick="edit_commentimgtwo(' . $art_comment['post_image_comment_id'] .','.$post_image_id.')">Comment</button><div class="art-comment-menu-design"> <div class="comment-details-menu" id="likecommentimg' . $art_comment['post_image_comment_id'] . '">';
