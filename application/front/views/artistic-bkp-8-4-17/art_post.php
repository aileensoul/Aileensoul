...
<!-- pop up box end-->
              ...
              <?php 
                 ...
                 ?>
                        ...
                        <li><div class="post-design-product"><a href="<?php echo base_url('artistic/art_manage_post/'.$row['user_id']); ?>"><?php echo ucwords($firstname); print "&nbsp;&nbsp;"; echo ucwords($lastname); ?> <span> <?php echo date('d-M-Y',strtotime($row['created_date'])); ?></span></a> </div></li>
                        <!-- 
