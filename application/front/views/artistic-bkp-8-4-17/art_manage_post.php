...
foreach ($artsdata as $row) {
    ...
    if (!in_array($userid, $likeuserarray)) {
        ...
        ?>
                                                    <a href="<?php echo base_url('artistic/art_manage_post/' . $row['user_id']); ?>">
                                                        <h6> <?php echo ucwords($firstname) . ' ' . ucwords($lastname); ?></h6> <span> <?php echo date('d-M-Y', strtotime($row['created_date'])); ?></span>
                                                    </a>
                                                </li>
                                                <li>
        ...
        <?php if (count($artmultiimage) == 1) { ?>
            ...
            if (in_array($ext, $allowed)) {
                ?>
                                                    ...
                                                    <!-- one image start -->
                                                    <div>
                                                        <a href="<?php echo base_url('artistic/postnewpage/' . $row['art_post_id']) ?>"><img src="<?php echo base_url(ARTPOSTIMAGE . str_replace(" ", "_", $artmultiimage[0]['image_name'])) ?>" style=""> </a>
                                                    </div>
                                                    <!-- one image end -->
        ...
        <?php } elseif (count($artmultiimage) == 5) { ?>
        ...
        if ($artdata) {
            foreach ($artdata as $rowdata) {
                ...
                ?>
                                                    ...
                                                    echo "&nbsp;";
                                                    echo ucwords($artlastname); ?></b><?php echo '</br>';
                                                    ?>
                                                            </div>
