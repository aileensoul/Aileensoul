                                ...
                                if (in_array($toid, $userlist)) {
                                    foreach ($userlist as $user) {
                                        ...
                                        ?>" onclick="new_chat(<?php echo $user['user_id'] ?>);" id="user_list_<?php echo $user['user_id'] ?>">
                                            ...
                                            <div class="about">
                                                <div class="name"> 
                                                    <!--<a href="<?php echo base_url() . 'chat/abc/' . $user['user_id'] . '/' . $message_from_profile . '/' . $message_to_profile; ?>"><?php echo $user['first_name'] . ' ' . $user['last_name'] . "<br>"; ?></a>--> 
                                                    <a href="javascript:void(0);"><?php echo $user['first_name'] . ' ' . $user['last_name'] . "<br>"; ?></a> 
                                                </div>
                                            ...
                                            <div class="about">
                                                <div class="name"> 
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        ...
                                                        <?php
                                                        $fullname = $last_user_data['first_name'] . ' ' . $last_user_data['last_name'];
