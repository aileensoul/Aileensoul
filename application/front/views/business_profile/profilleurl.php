                ...
                <div class="col-md-7 col-sm-7">
                    <div class="common-form">
                        <div class="job-saved-box">
                            ...
                            <?php if ($this->session->userdata('aileenuser') == $businessdata[0]['user_id']) { ?>
                                            ...
                                            <div class="profile-job-profile-menu">
                                                <ul class="clearfix">
                                                    ...
                                                    <li> <b>State :</b><span> <?php
                                                            echo
                                                            $this->db->get_where('states', array('state_id' => $businessdata[0]['state']))->row()->state_name;
                                                            ?> </span>
                                                    </li>
                                                    <li><b> City:</b> <span><?php
                                                            echo
                                                            $this->db->get_where('cities', array('city_id' => $businessdata[0]['city']))->row()->city_name;
                                                            ?></span> </li>
                                                ...
                                                <div class="profile-job-profile-menu">
                                                    <ul class="clearfix">
                                                        <li> <b>Buisness  Type :-</b> <span><?php
                                                            echo
                                                            $this->db->get_where('business_type', array('type_id' => $businessdata[0]['business_type']))->row()->business_type;
                                                            ?></span> </span>
                                                        </li>

                                                        <li> <b>Industrial:-</b><span><?php
                                                            echo
                                                            $this->db->get_where('industry_type', array('industry_id' => $businessdata[0]['industriyal']))->row()->industry_name;
                                                            ?></span>
                                                        </li>
                                                        <li><b>Sub Industrial:-</b> <span><?php
                                                                echo
                                                                $this->db->get_where('sub_industry_type', array('sub_industry_id' => $businessdata[0]['subindustriyal']))->row()->sub_industry_name;
                                                            ?></span> </li>
