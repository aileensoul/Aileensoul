            ...
            <!-- menubar --><div class="buisness-data-menu  col-md-12 ">
                ...
                <div class="profile-main-box-buis-menu fr col-md-9">  
                    <ul class="">
                        ...
                        <?php
                        if (($this->uri->segment(1) == 'business_profile') && ($this->uri->segment(2) == 'business_profile_post' || $this->uri->segment(2) == 'business_resume' || $this->uri->segment(2) == 'business_profile_manage_post' || $this->uri->segment(2) == 'business_profile_save_post' || $this->uri->segment(2) == 'userlist' || $this->uri->segment(2) == 'followers' || $this->uri->segment(2) == 'following') && ($this->uri->segment(3) == $this->session->userdata('aileenuser') || $this->uri->segment(3) == '')) {
                            ?>
...
<!-- <script src="https://code.jquery.com/jquery-1.12.4.js"></script> -->
            ...
            type: 'POST',
                            url: '<?php echo base_url() . "business_profile/insert_comment" ?>',
                                        ...
                                        dataType: "json",
                                    success: function (data) {                                 $('input').each(function () {
                                        $(this).val('');
                                });
                ...
                <script type="text/javascript">                     function comment_like1(clicked_id)
                        {
                        //alert(clicked_id);
                        $.ajax({
                            type: 'POST',
                    ...
                    function comment_editcancle2(clicked_id) {
                        ...
                        document.getElementById('editcommentbox2' + clicked_id).style.display = 'block';
                            ...
                            document.getElementById('editcomment2' + clicked_id).style.display = 'none';
                                document.getElementById('showcomment2' + clicked_id).style.display = 'block';                         document.getElementById('editsubmit2' + clicked_id).style.display = 'none';
            ...
            success: function (data) { //alert('falguni');
                ...
                <script type="text/javascript">
                    ...
                    return;
                        ...
                        window.preventDuplicateKeyPresses = true;
                            window.setTimeout(function () {
                                    window.preventDuplicateKeyPresses = false;                                     }, 500);
                ...
                <script type="text/javascript">
                                        function editpost(abc)
                    {
                                            ...
                                            document.getElementById('editpostdata' + abc).style.display = 'none';                         document.getElementById('editpostbox' + abc).style.display = 'block';
