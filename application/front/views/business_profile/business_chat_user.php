                            ...
                            if (in_array($toid, $userlist)) {
                                foreach ($userlist as $user) {
                                    ...
                                    ?>">
                                        ...
                                        <div class="about">
                                            <div class="name"> 
                                                <a href="<?php echo base_url() . 'chat/abc/5/5/' . $user['user_id']; ?>"><?php echo $user['first_name'] . ' ' . $user['last_name'] . "<br>"; ?></a> </div>
                                ...
                                if ($lstusrdata) {
                                    ...
                                    ?>">
                                        ...
                                        <div class="about">
                                            <div class="name"> 
                                                <a href="<?php echo base_url() . 'chat/abc/5/5/' . $lstusrdata[0]['user_id']; ?>"><?php echo $lstusrdata[0]['first_name'] . ' ' . $lstusrdata[0]['last_name'] . "<br>"; ?></a> </div>
