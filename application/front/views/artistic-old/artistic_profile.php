...
<div class="right-side-menu col-md-9">
                             ...
                             <?php }?>
                                   ...
                                   <li <?php if($this->uri->segment(1) == 'artistic' && $this->uri->segment(2) == 'artistic_profile'){?> class="active" <?php } ?>><a href="<?php echo base_url('artistic/artistic_profile'); ?>"> Profile</a>
                                    ...
                                    <li <?php if($this->uri->segment(1) == 'artistic' && $this->uri->segment(2) == 'art_savepost'){?> class="active" <?php } ?>><a href="<?php echo base_url('artistic/art_savepost/'.$artisticdata[0]['user_id']); ?>">Post </a>
                                    </li>
                                   ...
                                   <div class="profile-job-post-title clearfix">
                                                ...
                                                <div class="profile-job-profile-menu">
                                                    <ul class="clearfix">
                                                        ...
                                                        $this->db->get_where('states',array('state_id' => $artisticdata[0]['art_state']))->row()->state_name;  ?> </span>
                                                        </li>
                                                        <li><b> City</b> <span><?php echo  
                                                        $this->db->get_where('cities',array('city_id' => $artisticdata[0]['art_city']))->row()->city_name;  ?></span> </li>
                                                ...
                                                <div class="profile-job-profile-menu">
                                                    <ul class="clearfix">
                                                        <li> <b> What Is Your Art </b> <span> <?php echo $artisticdata[0]['art_yourart']; ?> </span>
                                                        </li>
                                                       
                                                      
                                                        <li><b> How You Are Inspire</b> <span><?php echo $artisticdata[0]['art_inspire']; ?></span> </li>

                                                        <li><b> Description of My Art</b> <span><?php echo $artisticdata[0]['art_desc_art']; ?></span> </li>
                                     ...
                                     <?php }
                                        ...
                                        <video width="320" height="240" controls>
                                                  ...
                                                  <audio width="120" height="100" controls>
                                                        ...
                                                        <li> <b>About Myself </b> <span> <?php echo $artisticdata[0]['art_portfolio']; ?> </span>
                                                        </li>
