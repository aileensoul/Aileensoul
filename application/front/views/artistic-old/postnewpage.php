 ...
 <div class="col-md-7 col-sm-7 all-form-content">
                ...
                <div class=" ">
                 ...
                 ?>
                        ...
                        <li><div class="post-design-product"><a href="<?php echo base_url('artistic/artistic_profile/'.$row['user_id']); ?>"><?php echo ucwords($firstname); print "&nbsp;&nbsp;"; echo ucwords($lastname); ?> <span> <?php echo date('d-M-Y',strtotime($art_data[0]['created_date'])); ?></span></a> </div></li>
                        <!-- 
                  ...
                  <?php 
                      foreach ($artmultiimage as $multiimage) {
                           ...
                           //  echo '<pre>'; print_r($allowed); 
                                                       ...
                                                       <img src="<?php echo base_url(ARTPOSTIMAGE. str_replace(" ","_",$multiimage['image_name']))?>" style=""> 
                                                          <?php
                                                       }
