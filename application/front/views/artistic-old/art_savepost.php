...
<?php echo form_error('designation'); ?>
  ...
  <fieldset class="col-md-2"><input type="submit"  id="submitdes" name="submitdes" value="Submit"></fieldset>
            ...
            <!-- text head end -->
               ...
               <div class="tablet-hi">
  <a href="javascript:void(0)" class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Post</a>

  <?php
  $userid = $this->session->userdata('aileenuser');
  if($artisticdata[0]['user_id'] == $userid) {
  ?>
  <a href="javascript:void(0)" class="tablinks" onclick="openCity(event, 'Paris')">Saved Post</a>
  <?php }?>
</div>                                 


<!-- artsitics manage post start-->
                ...
                <div>
                    ...
                    <div class="post-design-product-img">
                     <?php
                                                       ...
                                                       <img src="<?php echo base_url(ARTISTICIMAGE.$row['art_attachment'])?>" > 
                                                          <?php
                                                       }
...
<!-- artsitics manage post end-->
<!-- artsitics save post start-->
...
<!-- pop up box end-->
                 ...
                 $lastname =  $this->db->get_where('art_reg',array('user_id' => $row['user_id']))->row()->art_lastname; 
                 ?>
                        <li><a href="<?php echo base_url('artistic/artistic_profile/'.$row['user_id']); ?>"><h6> <?php echo ucwords($firstname) . ucwords($lastname) ;?></h6></a></li>
                        <li ><div class="post-design-product"><?php echo $row['art_post']?><span><?php  echo date('d-M-Y',strtotime($row['created_date'])); ?></span></div></li>
                       <!--  <li><a href="">T-Shirt</a></li> -->
                      </ul> 
                      </div>  
