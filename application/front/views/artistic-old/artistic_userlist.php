...
<div class="right-side-menu col-md-9">
    ...
    <!-- menubar -->                
                          ...
                          <a href="<?php echo site_url('artistic/artistic_profile/'.$artisticdata[0]['user_id']); ?>"> <h5 > <?php echo ucwords($artisticdata[0]['art_name']) .' '.  ucwords($artisticdata[0]['art_lastname']); ?>
                          </h5></a>
                             <!-- text head start -->
                    ...
                    <div>
                        ...
                        <?php foreach ($userlist as $user) { ?>
                         ...
                         <div class="follow-li-text ">
                                <a href="<?php echo base_url('artistic/artistic_profile/'.$user['user_id']); ?>"><?php echo $user['art_name'];?></a></div>
                            </li>
                            
                            <li class="<?php echo "fr" . $user['art_id']; ?>">
