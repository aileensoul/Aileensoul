...
?>
          ...
          <div class="top-row">
            <div class="field-wrap full-width">
             ...
             <input type="text" name="email" id="email" placeholder="" value="<?php if($email){ echo $email; }?>" autocomplete="false">
    ...
    <input type="password" name="password" id="password" class="showpassword" placeholder="Password *" style="position: relative;" autocomplete="false">
