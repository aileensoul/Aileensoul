...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <body class="main-page">
                        ...
                        <div class="col-md-7 col-sm-7 header-left-menu">
                            <div class="pushmenu pushmenu-left">
                                ...
                                <input id="user_name"  type="text" name="user_name" autocomplete="off"/>
                                                            ...
                                                            <!-- <div class="checkbox2 show" style="display: block;">
        ...
        <section id="section-height" style="height: 100%;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-menu pull-left">
                    <p>copyright 2017 | by <a href="#">Aileensoul</a></p>
                </div>
                </div>
                <div class="col-md-6">
    ...
    $(function () {
        $(".showpassword").each(function (index, input) {
            ...
            $('<div class="checkbox2 show" style="display: block;">').append(
                    $("<input type='checkbox' class='showpasswordcheckbox' id='password1' /></div> ").click(function () {
...
<li><a href="https://www.aileensoul.com/login"></a></li>
<li><a href="https://www.aileensoul.com/registration"></a></li>
<li><a href="https://www.aileensoul.com/contact_us"></a></li>
<li><a href="https://www.aileensoul.com/feedback"></a></li>