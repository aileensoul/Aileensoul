        ...
        ?>
                                                        ...
                                                        <li>
                                                            <div class="post-design-product"><a style="    font-size: 16px;
                                                                                                line-height: 24px; font-weight: 600; color: #000033; margin-bottom: 4px; " href="<?php echo base_url('artistic/art_manage_post/' . $row['user_id']); ?>"><?php echo ucwords($firstname);
        print "&nbsp;&nbsp;";
        echo ucwords($lastname); ?> <span style="font-weight: 400;"> <?php echo date('d-M-Y', strtotime($row['created_date'])); ?></span></a> </div></li>
                                                        <!-- 
        ...
        if ($artdata) {
            foreach ($artdata as $rowdata) {
                ...
                ?>
                                                                ...
                                                                echo "&nbsp;";
                                                                echo ucwords($artlastname); ?></b><?php echo '</br>'; ?></div>
...
// Reached the Maximum length so trim the textarea
                                ...
                                my_form.text_num.value = maxLen - my_for                    m.my                    _text.value.length;
                                }
                                }
                        //-->
</script>
...
<!-- success message remove after some seco                                    nd end -->
<!-- edit post start -->
                                    <script type="                                       text/javascript">
   ...
   { 
       ...
       document.getElementById('ed                                           itpostdetails' + abc).style.display='none';
       document.getElementById('editp                                           ostdetailbox' + abc).style.display='block';
       document.getElementById('editpostsub                                    mi                                            t' + abc).                                            style.display='block';
...
<!-- save post end -->
                                                <script>
                                                    /* When the user clicks on the button,                                                        
                                                     toggle b                                                            etween hiding and showing the dr                                                            opdown content */
                                                        </script>
...
<!-- remove particu                                                                    lar user post end -->
<!-- follow user script start -->
                                                                ...
                                                                <script type="text/javascript">
                                                                    function                                                                     fo                                                                        llowclose(clicked_id)
                                                                            {
...
<!--follow like script end -->
                                                                    <script>
                                                                        ...
                                                                        language: 'fr',
                                                                                uploadUrl: '#',
                                                                                allowedFileExtensions: ['jpg', '                                                                            png', 'g                                                                            if']
                                                                        });
                                                                        $('#file-es').fileinput({
                                                                        language: 'es',
                                                                                uploadUrl: '#',
                                                                        ...
                                                                        $("#file-0").fileinput({
                                                                        'allowedFileExten                                                                            sions': ['                                                                            jpg', 'p                                                                            ng', 'g                                                                            if']
                                                                        });
                                                                        $("#file-1").fileinput({
                                                                        ...
                                                                        /*
                                                                         ...
                                                                         alert('Huh! You selec                                                                                ted no files.');
                                                                         });
                                                                         $('#file-4'                                                                                ).on('filebrow                                                                                se', functio                                                                                n() {
                                                                         ...
                                                                         */
                                                                                ...
                                                                                <script type="text/javascript">
                                                                                    var span = $('<span>').css('dis                                                                                                    play', 'inline-block')
...
//var fileInput = document.getElementById('test-upload');
                                                                                    ...
                                                                                    for (var i = 0; i < fileInput.length; i++)
                                                                                            ...
                                                                                            $('#bidmodal').modal('show');
                                                                                            setInterval('window.locat                                                                                                            ion.reload()', 1000                                                                                                            0);
                                                                                            // window.location='';
                                                                                            event.preventDefault();
                                                                                            return false;
                                                                                            }
                                                                                            ...
                                                                                            else if (foundP                                                                                                            resentaudio == true)
                                                                                            {
