...
<section id="section-height" style="height: 679px;">
        <div id="particles-js"></div>

        <div class="banner_cnt_reg text-center clearfix" style="top: 20px;">
            <div class="form" style="max-width: 80%;">
                <div class="tab-group">
                    <ul>
                        <div class="logo1"><!-- <img src="<?php echo base_url('partical/images/khalilogo.png'); ?>"> --></div>
                        <li class="tab active"><a class="head-ail">Send us Feedback</a></li>
                    </ul>
                </div>
