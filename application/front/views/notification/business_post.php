                  ...
                  <div class="col-md-12 col-sm-12 post-design-box">
                     ...
                     <div  class="">
                        <div class="post-design-top col-md-12" >
                           ...
                           <div class="post-design-name fl col-md-9">
                              <ul>
                                 ...
                                 <li>
                                    <div class="post-design-product"><a><?php echo ucwords($category); ?></a></div>
                                 </li>
                              </ul>
                           </div>
                           <div class="dropdown1">
                        ...
                        <div class="post-design-mid col-md-12">
                           ...
                           <div>
                              ...
                              <div id="two_images_bui" >
                                 <img src="<?php echo base_url(BUSPOSTIMAGE . $data['image_name']) ?>" onclick="openModal();
                              ...
                              <div class="modal-content2">
                                 ...
                                 <div class="mySlides">
                                    ...
                                    <div class="slider_img">
                                       <img src="<?php echo base_url(BUSPOSTIMAGE . $busdata['image_name']) ?>" >
                                    </div>
                                    <!-- like comment start -->
                                    <div>
                        ...
                        <div class="post-design-commnet-box col-md-12">
                           ...
                           <div class="">
                              <div class="col-md-10 inputtype-comment" style="    padding-left: 7px;">
                                 <div contenteditable="true" class="editable_text" name="<?php echo $busienss_data[0]['business_profile_post_id']; ?>"  id="<?php echo "post_comment" . $busienss_data[0]['business_profile_post_id']; ?>" placeholder="Type Message ..." value= "" onClick="entercomment(<?php echo $busienss_data[0]['business_profile_post_id']; ?>)"></div>
                              </div>
