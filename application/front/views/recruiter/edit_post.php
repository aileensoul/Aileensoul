                ...
                <div class="row">
                 ...
                 <?php
                    ...
                    <fieldset class="full-width">
                        ...
                        <input name="post_name" tabindex="1" autofocus type="text" id="post_name" placeholder=" Position [Ex:- Sr. Engineer, Jr. Engineer]" value="<?php echo $work_title; ?>" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value"/>
