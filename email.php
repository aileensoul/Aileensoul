...
public function compose($slug = "") 
{
   ...
   // echo $slug;die();
    ...
    $this->data['email']  = $this->common->select_data_by_condition('emails_seo', $condition_array, $data='*', $short_by='', $order_by='', $limit, $offset, $join_str = array());
     ...
     $this->data['receiver']  = $this->common->select_data_by_condition('seo_mail_list', $condition_array= array(), $data='*', $short_by='', $order_by='', $limit, $offset, $join_str = array());

   //  echo "<pre>";print_r($this->data['receiver']);die();
    $this->data['slug']=$slug;
...
//LIST OF BLOG ADD BY ADMIN START
 ...
 {    
     ...
     if($slug =='artistic')
     {
       ...
       // echo "<pre>";print_r($to_mail);die();
        foreach($to_mail as $key => $mail)
        {  
            //$receiver= $this->common->select_data_by_condition('seo_mail_list', $condition_array= array(), $data='*', $short_by='', $order_by='', $limit, $offset, $join_str = array());

          //  $mail = $this->email_model->sendEmail($app_name = $receiver[$key]['name'], $app_email = '', $mail , $subject, $msg);
